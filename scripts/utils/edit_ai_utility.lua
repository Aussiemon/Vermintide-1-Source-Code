...
EditAiUtility.update = function (self, unit, t, dt, input_service, blackboard)
	...
	if blackboard then
		slot11 = Vector2(window_list[1].x, window_list[1].y)
	end
...
EditAiUtility.save_considerations = function (self)
	...
	local write_string = "UtilityConsiderations = " .. serialize.save_simple(UtilityConsiderations)
