...
AISpawner.spawn_unit = function (self)
	...
	conflict_director:spawn_queued_unit(breed, Vector3Box(spawn_pos), QuaternionBox(spawn_rotation), spawn_category, spawn_animation, spawn_type, inventory_template, group_template)
