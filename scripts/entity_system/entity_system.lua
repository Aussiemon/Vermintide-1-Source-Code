...
EntitySystem._init_systems = function (self, entity_system_creation_context)
	...
	self._add_system(self, "outline_system", OutlineSystem, entity_system_creation_context)
	...
	self._add_system(self, "ai_commander_system", AICommanderSystem, entity_system_creation_context)
	...
	self._add_system(self, "damage_system", DamageSystem, entity_system_creation_context, nil, has_pre_update)
	...
	self._add_system(self, "charge_system", ExtensionSystemBase, entity_system_creation_context, {
	...
	self._add_system(self, "aim_system", ExtensionSystemBase, entity_system_creation_context, {
	...
	self._add_system(self, "sound_sector_system", SoundSectorSystem, entity_system_creation_context)
	...
	self._add_system(self, "sound_environment_system", SoundEnvironmentSystem, entity_system_creation_context)
