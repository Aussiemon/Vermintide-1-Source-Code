...
BTSelector_gutter_runner_heroic.run = function (self, unit, blackboard, t, dt)
	...
	if condition_result then
		self.set_running_child(self, unit, blackboard, t, node_uninterruptable_ninja_vanish, "aborted")
		Profiler_start("uninterruptable_ninja_vanish")

		local result, evaluate = node_uninterruptable_ninja_vanish.run(node_uninterruptable_ninja_vanish, unit, blackboard, t, dt)
	...
	if condition_result then
		self.set_running_child(self, unit, blackboard, t, node_throw_throwing_stars, "aborted")
		Profiler_start("throw_throwing_stars")

		local result, evaluate = node_throw_throwing_stars.run(node_throw_throwing_stars, unit, blackboard, t, dt)
