...
BTMoveToPlayersAction.leave = function (self, unit, blackboard, t, reason)
...
BTMoveToPlayersAction._find_target_globadier = function (self, unit, blackboard, action, next_target_unit, t)
	...
	if self:_valid_globadier_target(blackboard.target_dist, action) and self:_has_line_of_sight(unit, next_target_unit, blackboard.world, t) then
