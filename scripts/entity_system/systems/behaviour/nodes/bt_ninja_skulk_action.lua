...
BTNinjaSkulkAction.leave = function (self, unit, blackboard, t, reason)
...
BTNinjaSkulkAction.get_new_goal = function (self, unit, blackboard)
	if Unit.alive(blackboard.target_unit) then
		...
		local max_tries = 5
		pos = LocomotionUtils.outside_goal(blackboard.nav_world, unit, blackboard, min_dist, max_dist, angle, max_tries)
