...
BTAdvanceTowardsPlayersAction.leave = function (self, unit, blackboard, t, reason)
...
BTAdvanceTowardsPlayersAction.run = function (self, unit, blackboard, t, dt)
	...
	if can_throw and self:_calculate_trajectory_to_target(unit, blackboard.world, blackboard, action) then
