...
BTThrowPoisonGlobeAction.leave = function (self, unit, blackboard, t)
...
BTThrowPoisonGlobeAction.attack_throw = function (self, unit, t, dt, blackboard, locomotion, action)
	if blackboard.move_state ~= "throwing" then
		...
		blackboard.times_thrown = (blackboard.times_thrown and math.mod(blackboard.times_thrown + 1, action.barrage_count or 2)) or 1
		local action = blackboard.action
