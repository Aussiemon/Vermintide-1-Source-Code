...
BTTeleportAction.leave = function (self, unit, blackboard, t)
	...
	slot5 = navigation_extension.is_using_smart_object(navigation_extension) and navigation_extension.use_smart_object(navigation_extension, false)
