...
require("scripts/entity_system/systems/behaviour/nodes/bt_follow_action")
require("scripts/entity_system/systems/behaviour/nodes/bt_melee_slam_action")
require("scripts/entity_system/systems/behaviour/nodes/bt_melee_shove_action")
...
require("scripts/entity_system/systems/behaviour/nodes/bt_chase_action")
...
require("scripts/entity_system/systems/behaviour/nodes/bt_loot_rat_look_players_action")
...
require("scripts/entity_system/systems/behaviour/nodes/bt_ragdolled_action")
...
require("scripts/entity_system/systems/behaviour/nodes/bt_stunned_action")
...
require("scripts/entity_system/systems/behaviour/nodes/bt_move_randomly")
require("scripts/entity_system/systems/behaviour/nodes/bt_skaven_slave_attack_action")
...
require("scripts/entity_system/systems/behaviour/nodes/bt_bot_heal_other_action")
...
local function create_btnode_from_lua_node(lua_node, parent_btnode)
	...
	if not class_type then
		...
		return class_type.new(class_type, identifier, parent_btnode, condition_name, hook_name, lua_node), action_data
	end
