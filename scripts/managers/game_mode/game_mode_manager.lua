...
GameModeManager.init = function (self, world, lobby_host, lobby_client, level_transition_handler, network_event_delegate, statistics_db, game_mode_key, network_server)
	...
	event_manager:register(self, "gm_event_survival_wave_completed", "gm_event_survival_wave_completed")
...
GameModeManager.gm_event_survival_wave_completed = function (self, difficulty)
	...
	db:increment_stat(stats_id, "last_stand_waves_completed", difficulty)
end
...
GameModeManager.change_game_mode = function (self, new_game_mode_key)
	self:_init_game_mode(new_game_mode_key)
end
