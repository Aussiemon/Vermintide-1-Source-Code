...
MatchmakingStateSearchGame.on_enter = function (self, state_context)
	...
	local level = (self.game_search_data.quick_game and "level_any") or self.game_search_data.level_key
	local difficulty = self.game_search_data.difficulty
	...
	self.matchmaking_ui:large_window_set_ready_button_text("matchmaking_surfix_become_host", "matchmaking_ready")
...
MatchmakingStateSearchGame.update = function (self, dt, t)
	...
	elseif input_service.get(input_service, "matchmaking_ready") and self.next_state_timer == nil then
...
MatchmakingStateSearchGame.search_for_game = function (self, dt)
	...
	matchmaking_manager.debug.level = (quick_game and "random") or search_data.level_key
