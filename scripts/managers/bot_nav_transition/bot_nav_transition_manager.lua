...
BotNavTransitionManager.create_transition = function (self, from, via, wanted_to, player_jumped, make_permanent)
	...
	if not found_nav_mesh then
		...
		wanted_to = GwNavQueries.inside_position_from_outside_position(nav_world, wanted_to, beneath, above, lateral)
	...
	local unit = World.spawn_unit(self._world, "scripts/managers/bot_nav_transition/bot_nav_transition", from)
