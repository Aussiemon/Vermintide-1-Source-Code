...
ConsoleDLCView._create_dlc_widgets = function (self)
	...
	self:_setup_scrollbar(self._dlcs)
	self:_update_selection(self._dlc_index)
...
ConsoleDLCView._create_skins_widgets = function (self)
	...
	self:_setup_scrollbar(self._skin_dlcs)
	self:_update_selection(self._dlc_index)
...
ConsoleDLCView.on_enter = function (self)
	...
	input_manager:block_device_except_service("console_dlc", "mouse", 1)
	input_manager:block_device_except_service("console_dlc", "keyboard", 1)
	input_manager:block_device_except_service("console_dlc", "gamepad", 1)
...
ConsoleDLCView.update = function (self, dt, t)
	...
	self:_update_menu_description(dt, t)
	self:_update_scrollbar(dt, t)
	self:_update_input(dt, t)
	self:_update_animations(dt, t)
	self:_update_video(dt, t)
	self:_draw(dt, t)
	self:_handle_popup(dt, t)
end
...
ConsoleDLCView._update_input = function (self, dt, t)
	...
	if input_service:get("move_up") and self._dlc_index > 1 then
		self:_update_selection(self._dlc_index - 1)
		self:_play_sound("Play_hud_next_tab")
	elseif input_service:get("move_down") and self._dlc_index < self._num_dlcs then
		self:_update_selection(self._dlc_index + 1)
		self:_play_sound("Play_hud_next_tab")
