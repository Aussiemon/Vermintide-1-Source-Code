		...
		if player == my_player then
			...
			if not player_portrait_widget then
				...
				if not profile_index then
					...
					self.on_num_grimoires_changed(self, "player_" .. index .. "_grimoires", player_portrait_widget, active_percentage - 1)
...
UnitFramesUI.update_player_unit_frame = function (self, dt, t, ui_scenegraph, ui_renderer, peer_id, local_player_id, my_player)
	...
	self.on_num_grimoires_changed(self, "my_player_grimoires", player_portrait, active_percentage - 1)
