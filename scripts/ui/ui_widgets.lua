...
UIWidgets.create_gamepad_selection = function (scenegraph_id, retained, masked, optional_texture_size)
	return {
		...
		content = {
			texture_bottom_left = "quest_gamepad_frame_glow_03",
			texture_bottom_right = "quest_gamepad_frame_glow_04",
			texture_top_left = "quest_gamepad_frame_glow_01",
			texture_top_right = "quest_gamepad_frame_glow_02"
		},
		style = {
			texture_top_left = {
				vertical_alignment = "top",
