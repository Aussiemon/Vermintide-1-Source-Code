...
Weapons.shortbow_bodkin_template_1_co = table.clone(weapon_template)
Weapons.shortbow_bodkin_template_1_co.compare_statistics.attacks.light_attack.damage = 0.275
Weapons.shortbow_bodkin_template_1_co.compare_statistics.attacks.heavy_attack.damage = 0.55
Weapons.shortbow_bodkin_template_1_t2 = table.clone(weapon_template)
Weapons.shortbow_bodkin_template_1_t2.ammo_data.ammo_unit = "units/weapons/player/wpn_we_quiver_t1/wpn_we_arrow_t2"
Weapons.shortbow_bodkin_template_1_t2.ammo_data.ammo_unit_3p = "units/weapons/player/wpn_we_quiver_t1/wpn_we_arrow_t2_3p"
Weapons.shortbow_bodkin_template_1_t2.actions.action_one.default.projectile_info = Projectiles.machinegun_arrow_bodkin_t2
Weapons.shortbow_bodkin_template_1_t2.actions.action_one.shoot_charged.projectile_info = Projectiles.carbine_arrow_bodkin_t2
Weapons.shortbow_bodkin_template_1_t2.compare_statistics.attacks.light_attack.damage = 0.3125
Weapons.shortbow_bodkin_template_1_t2.compare_statistics.attacks.heavy_attack.damage = 0.625
Weapons.shortbow_bodkin_template_1_t3 = table.clone(weapon_template)
Weapons.shortbow_bodkin_template_1_t3.ammo_data.ammo_unit = "units/weapons/player/wpn_we_quiver_t1/wpn_we_arrow_t3"
Weapons.shortbow_bodkin_template_1_t3.ammo_data.ammo_unit_3p = "units/weapons/player/wpn_we_quiver_t1/wpn_we_arrow_t3_3p"
Weapons.shortbow_bodkin_template_1_t3.actions.action_one.default.projectile_info = Projectiles.machinegun_arrow_bodkin_t3
Weapons.shortbow_bodkin_template_1_t3.actions.action_one.shoot_charged.projectile_info = Projectiles.carbine_arrow_bodkin_t3
Weapons.shortbow_bodkin_template_1_t3.compare_statistics.attacks.light_attack.damage = 0.375
Weapons.shortbow_bodkin_template_1_t3.compare_statistics.attacks.heavy_attack.damage = 0.75
