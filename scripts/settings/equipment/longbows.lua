...
weapon_template.actions = {
	action_one = {
		default = {
			fire_at_gaze_setting = "tobii_fire_at_gaze_longbow",
			ammo_usage = 1,
			kind = "bow",
			max_penetrations = 1,
...
weapon_template.fire_at_gaze_setting = "tobii_fire_at_gaze_longbow"
...
Weapons.longbow_template_1_co = table.create_copy(Weapons.longbow_template_1_co, weapon_template)
Weapons.longbow_template_1_co.compare_statistics.attacks.light_attack.damage = 0.55
Weapons.longbow_template_1_co.compare_statistics.attacks.heavy_attack.damage = 0.825
Weapons.longbow_template_1_t2 = table.create_copy(Weapons.longbow_template_1_t2, weapon_template)
Weapons.longbow_template_1_t2.ammo_data.ammo_unit = "units/weapons/player/wpn_we_quiver_t1/wpn_we_arrow_t2"
Weapons.longbow_template_1_t2.ammo_data.ammo_unit_3p = "units/weapons/player/wpn_we_quiver_t1/wpn_we_arrow_t2_3p"
Weapons.longbow_template_1_t2.actions.action_one.default.projectile_info = Projectiles.carbine_arrow_t2
Weapons.longbow_template_1_t2.actions.action_one.shoot_charged.projectile_info = Projectiles.sniper_arrow_t2
Weapons.longbow_template_1_t2.compare_statistics.attacks.light_attack.damage = 0.625
Weapons.longbow_template_1_t2.compare_statistics.attacks.heavy_attack.damage = 0.875
Weapons.longbow_template_1_t3 = table.create_copy(Weapons.longbow_template_1_t3, weapon_template)
Weapons.longbow_template_1_t3.ammo_data.ammo_unit = "units/weapons/player/wpn_we_quiver_t1/wpn_we_arrow_t3"
Weapons.longbow_template_1_t3.ammo_data.ammo_unit_3p = "units/weapons/player/wpn_we_quiver_t1/wpn_we_arrow_t3_3p"
Weapons.longbow_template_1_t3.actions.action_one.default.projectile_info = Projectiles.carbine_arrow_t3
Weapons.longbow_template_1_t3.actions.action_one.shoot_charged.projectile_info = Projectiles.sniper_arrow_t3
Weapons.longbow_template_1_t3.compare_statistics.attacks.light_attack.damage = 0.75
Weapons.longbow_template_1_t3.compare_statistics.attacks.heavy_attack.damage = 0.9375
