...
weapon_template.actions = {
	action_one = {
		default = {
			fire_at_gaze_setting = "tobii_fire_at_gaze_hagbane",
			ammo_usage = 1,
			kind = "bow",
			max_penetrations = 1,
...
weapon_template.fire_at_gaze_setting = "tobii_fire_at_gaze_hagbane"
...
Weapons.longbow_hagbane_template_1_co = table.clone(weapon_template)
Weapons.longbow_hagbane_template_1_co.compare_statistics.attacks.light_attack.damage = 0.32656250000000003
Weapons.longbow_hagbane_template_1_co.compare_statistics.attacks.heavy_attack.damage = 0.45375
Weapons.longbow_hagbane_template_1_t2 = table.clone(weapon_template)
Weapons.longbow_hagbane_template_1_t2.actions.action_one.default.projectile_info = Projectiles.carbine_poison_arrow_t2
Weapons.longbow_hagbane_template_1_t2.actions.action_one.shoot_charged.projectile_info = Projectiles.sniper_poison_arrow_t3
Weapons.longbow_hagbane_template_1_t2.compare_statistics.attacks.light_attack.damage = 0.36875
Weapons.longbow_hagbane_template_1_t2.compare_statistics.attacks.heavy_attack.damage = 0.49375
Weapons.longbow_hagbane_template_1_t3 = table.clone(weapon_template)
Weapons.longbow_hagbane_template_1_t3.actions.action_one.default.projectile_info = Projectiles.carbine_poison_arrow_t2
Weapons.longbow_hagbane_template_1_t3.actions.action_one.shoot_charged.projectile_info = Projectiles.sniper_poison_arrow_t3
