...
EnvironmentBlender.event_register_environment_volume = function (self, volume_name, environment_name, priority, blend_time, override_sun_snap, particle_light_intensity)
	local blend_data = {
		always_inside = false,
	...
	self.environment_handler:add_blend("EnvironmentBlendVolume", "volumes", priority, blend_data)
