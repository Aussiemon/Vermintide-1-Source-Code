...
ProjectileTemplates.timed_templates = {}
...
ProjectileTemplates.get_timed_template = function (timed_template_name)
	local templates = ProjectileTemplates.timed_templates
	local template = templates[timed_template_name]
