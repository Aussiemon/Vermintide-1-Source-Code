...
PlayerProjectileImpactUnitExtension.init = function (self, extension_init_context, unit, extension_init_data)
	...
	self.collision_filter = projectile_info.collision_filter or collision_filter
...
PlayerProjectileImpactUnitExtension.update = function (self, unit, input, dt, context, t)
	...
	elseif impact_type == "sphere_sweep" then
		self.update_sphere_sweep(self, unit, input, dt, context, t)
	else
...
local INDEX_ACTOR = 4
PlayerProjectileImpactUnitExtension.update_raycast = function (self, unit, input, dt, context, t)
...
PlayerProjectileImpactUnitExtension.update_sphere_sweep = function (self, unit, input, dt, context, t)
	local locomotion_extension = self.locomotion_extension
