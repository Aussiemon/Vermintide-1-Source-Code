...
local function profile_packages(profile_index, packages_list, is_first_person)
...
InventoryPackageSynchronizerClient.build_inventory_lists = function (self, profile_index)
	...
	local inventory_list = profile_packages(profile_index, FrameTable.alloc_table(), false)
	local inventory_list_first_player = profile_packages(profile_index, FrameTable.alloc_table(), true)
